...
# undef SWK
	...
	SPAWN_KEY   ( MODKEY|ShiftMask,               XK_u,              MusPrev              )
	SPAWN_KEY   ( MODKEY|ShiftMask,               XK_i,              MusNext              )
	SPAWN_KEY   ( MODKEY|ShiftMask,               XK_o,              MusToggle            )
	...
	SPAWN_KEY   ( MODKEY|AltMask,                 XK_o,              PickSink             )
	SPAWN_KEY   ( MODKEY|AltMask|ControlMask,     XK_u,              MusSeekBackward      )
	SPAWN_KEY   ( MODKEY|AltMask|ControlMask,     XK_i,              MusSeekForward       )
	SPAWN_KEY   ( MODKEY|AltMask|ControlMask,     XK_o,              MusToggleShuffle     )
	SPAWN_KEY   ( MODKEY|AltMask|ShiftMask,       XK_o,              MusToggleRepeat      )
